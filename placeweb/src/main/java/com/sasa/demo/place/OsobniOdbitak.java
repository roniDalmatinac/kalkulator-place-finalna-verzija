...
public class OsobniOdbitak  {
	...
	protected  double ukupniOdbitak;
	protected  double noviBruto;
	...
	protected  double UkupnoPorezIPrirez;
	...
	public  double ukupniOdbitak(int brClanova, int brDjece) {
	...
	public double osnovica(double noviBruto, double ukupniOdbitak) {
		...
		System.out.println("dohodak nakon mirovinskog " + dohodak);
		 this.osnovicaZaObracunPoreza = dohodak - ukupniOdbitak;
	...
	public  void setUkupniPrirez(double ukupniPrirez) {
		this.ukupniPrirez = ukupniPrirez;
	}
	...
	public  double getUkupnoPorezIPrirez() {
		return UkupnoPorezIPrirez;
	}

	public  void setUkupnoPorezIPrirez(double ukupnoPorezIPrirez) {
